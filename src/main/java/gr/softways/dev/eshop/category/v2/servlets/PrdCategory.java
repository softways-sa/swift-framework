...
public class PrdCategory extends HttpServlet {
  ...
  private int doInsert(HttpServletRequest request, String databaseId) {
    ...
    int auth = director.auth(databaseId,authUsername,authPassword,"prdCategory",Director.AUTH_INSERT);
    ...
    String catId = SwissKnife.sqlEncode(request.getParameter("catId")),
           ...
           catRank = SwissKnife.sqlEncode(request.getParameter("catRank")),
           catDescr = SwissKnife.sqlEncode(request.getParameter("catDescr")),
           catDescrLG = SwissKnife.sqlEncode(request.getParameter("catDescrLG"));

    String catCustomerType = request.getParameter("catCustomerType");
    ...
    String query = "INSERT INTO prdCategory "
                 ...
                 + "keywordsUpLG,catShowFlag,catParentFlag,catRank,catDescr,catDescrLG";
                 
    if (catCustomerType != null) {
      query += ",catCustomerType";
    }
    ...
    if (catCustomerType != null) {
      if (catCustomerType.equals("")) query += ",null";
      else query += ",'" + SwissKnife.sqlEncode(catCustomerType) + "'";
    }
  ...
  private int doUpdate(HttpServletRequest request, String databaseId) {
    ...
    int auth = director.auth(databaseId,authUsername,authPassword,"prdCategory",Director.AUTH_UPDATE);
    ...
    String query = "UPDATE prdCategory SET"
                 ...
                 + ",catRank = '" + catRank + "'"
                 + ",catDescr = '" + catDescr + "'"
                 + ",catDescrLG = '" + catDescrLG + "'";
                 
    if (catCustomerType != null) {
      if (catCustomerType.equals("")) query += ",catCustomerType = null";
      else query += ",catCustomerType = '" + SwissKnife.sqlEncode(catCustomerType) + "'";
    }
  ...
  private int doDelete(HttpServletRequest request, String databaseId) {
    ...
    auth = director.auth(databaseId,authUsername,authPassword,"prdCategory",Director.AUTH_DELETE);
    ...
    query = "DELETE FROM prdCategory WHERE catId = '" + catId + "'";
