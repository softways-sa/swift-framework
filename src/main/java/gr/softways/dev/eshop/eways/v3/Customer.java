...
public class Customer {
  ...
  public DbRet doRegister(HttpServletRequest request) {
    ...
    String smtpServer = SwissKnife.jndiLookup("swconf/smtpServer"),
           emailFrom = SwissKnife.jndiLookup("swconf/shopEmailFrom");
    ...
    if (dbRet.getNoError() == 1) {
      sendRegistrationEmail(firstname,lastname,email,custLang,smtpServer,emailFrom);
    }
  ...
  **/
  ...
  private DbRet sendRegistrationEmail(String firstname,String lastname,String email,String custLang,String smtpServer,String emailFrom) {
    DbRet dbRet = new DbRet();
    ...
    if (custLang.equals("")) {
      subject = "Καλώς ήρθατε στο " + SwissKnife.jndiLookup("swconf/shopName");
      ...
      subject = "Welcome to " + SwissKnife.jndiLookup("swconf/shopName");
    ...
    body.append(SwissKnife.jndiLookup("swconf/shopName") + ls);
  ...
  public DbRet doSendLostPassword(HttpServletRequest request) {
    ...
    String smtpServer = SwissKnife.jndiLookup("swconf/smtpServer"),
           from = SwissKnife.jndiLookup("swconf/shopEmailFrom");
