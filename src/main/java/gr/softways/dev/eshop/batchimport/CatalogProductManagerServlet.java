 ...
 * @author  minotauros
 */
public class CatalogProductManagerServlet extends HttpServlet {
  ...
  private synchronized DbRet doProcessExcel(HttpServletRequest request,String databaseId,MultiRequest multi,String action) {
    ...
    if (dbRet.getNoError() == 0) {
      ...
      CatalogProductWorkerThread wt = new CatalogProductWorkerThread(this,action,inputFile,databaseId);
