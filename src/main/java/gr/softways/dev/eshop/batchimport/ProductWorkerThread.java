...
public class ProductWorkerThread extends Thread {
  ...
  private ProductManagerServlet _manager = null;
  ...
  public ProductWorkerThread(ProductManagerServlet manager,String action,File inputFile,String databaseId) {
  ...
  private DbRet doBatchUpdate(Sheet sheet, String databaseId, Director director) {
    ...
    PreparedStatement insertStatement = null,
        insCatStatement = null, updStatement = null;
    ...
    if (dbRet.getNoError() == 1) {
      query = "INSERT INTO product ("
          ...
          + ",PRD_VAT_ID,giftPrcEU,prdCompFlag"
          + ") VALUES ("
          + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?"
          + ")";
