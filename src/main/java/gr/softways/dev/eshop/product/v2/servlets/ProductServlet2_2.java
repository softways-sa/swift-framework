...
public class ProductServlet2_2 extends HttpServlet {
  ...
  private DbRet doInsert(HttpServletRequest request,String databaseId,MultiRequest multi,StrTokenizer denyFilesExtTokenizer,String uploadPath) {
    ...
    Timestamp prdEntryDate = SwissKnife.buildTimestamp(multi.getParameter("prdEntryDateDay"),
                                                       multi.getParameter("prdEntryDateMonth"),
                                                       multi.getParameter("prdEntryDateYear"));
